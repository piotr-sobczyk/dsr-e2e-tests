//[Piotr] Courtesy of mobify, shamelessly copied from this repo: https://github.com/mobify/nightwatch-commands
//
//Using just standard library would could do something like:
//.elements('css selector', 'table tr', function(result) {
//  this.assert.equal(result.value.length, 0, 'expected 0 rows');
//})
//But that is not very elegant.
//
//So why not reuse this elegant one?
